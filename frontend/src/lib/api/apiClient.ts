...
export class Client {
     ...
     * @return OK
     */
    r(token: string): Promise<void> {
        let url_ = this.baseUrl + "/api/mail/r/{token}";
        ...
        return this.http.fetch(url_, options_).then((_response: Response) => {
            return this.processR(_response);
        });
    }

    protected processR(response: Response): Promise<void> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
     ...
     * @return OK
     */
    p(token: string): Promise<void> {
        let url_ = this.baseUrl + "/api/mail/p/{token}.gif";
        if (token === undefined || token === null)
            throw new globalThis.Error("The parameter 'token' must be defined.");
        url_ = url_.replace("{token}", encodeURIComponent("" + token));
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.fetch(url_, options_).then((_response: Response) => {
            return this.processP(_response);
        });
    }

    protected processP(response: Response): Promise<void> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
        ...
        if (status === 200) {
            ...
            if (Array.isArray(resultData200)) {
                ...
                for (let item of resultData200)
                    result200!.push(SignupListItemDto.fromJS(item));
            }
            else {
     ...
     * @return OK
     */
    fieldsPUT(id: string, fieldId: string, body: UpsertSignupInputFieldRequest): Promise<SignupInputFieldDto> {
     ...
     * @return OK
     */
    reservation(id: string, responseId: string, body: SetReservationRequest): Promise<SignupResponseDto> {
    ...
    myWeek(weekStart: string | undefined): Promise<MyWeekAvailabilityDto> {
        ...
        if (weekStart === null)
            throw new globalThis.Error("The parameter 'weekStart' cannot be null.");
    ...
    protected processDay(response: Response): Promise<AvailabilityBlockDto[]> {
        ...
        if (status === 200) {
            ...
            if (Array.isArray(resultData200)) {
                result200 = [] as any;
                for (let item of resultData200)
                    result200!.push(AvailabilityBlockDto.fromJS(item));
            }
            else {
                result200 = null as any;
            }
     ...
     * @return OK
     */
    availability(instanceId: string, weekStart: string | undefined): Promise<InstanceWeekAvailabilityDto> {
     ...
     * @return OK
     */
    mailingsAll(): Promise<MailingDto[]> {
        let url_ = this.baseUrl + "/api/mailings";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.fetch(url_, options_).then((_response: Response) => {
            return this.processMailingsAll(_response);
        });
    }

    protected processMailingsAll(response: Response): Promise<MailingDto[]> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
            ...
            if (Array.isArray(resultData200)) {
                result200 = [] as any;
                for (let item of resultData200)
                    result200!.push(MailingDto.fromJS(item));
            }
            else {
                result200 = null as any;
            }
        ...
        return Promise.resolve<MailingDto[]>(null as any);
    }

    /**
     * @return OK
     */
    mailingsPOST(body: UpsertMailingRequest): Promise<MailingDto> {
        let url_ = this.baseUrl + "/api/mailings";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.fetch(url_, options_).then((_response: Response) => {
            return this.processMailingsPOST(_response);
        });
    }

    protected processMailingsPOST(response: Response): Promise<MailingDto> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
     ...
     * @return OK
     */
    mailingsGET(id: string): Promise<MailingDto> {
        let url_ = this.baseUrl + "/api/mailings/{id}";
        if (id === undefined || id === null)
            throw new globalThis.Error("The parameter 'id' must be defined.");
        url_ = url_.replace("{id}", encodeURIComponent("" + id));
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.fetch(url_, options_).then((_response: Response) => {
            return this.processMailingsGET(_response);
        });
    }

    protected processMailingsGET(response: Response): Promise<MailingDto> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
     ...
     * @return OK
     */
    mailingsPUT(id: string, body: UpsertMailingRequest): Promise<MailingDto> {
        let url_ = this.baseUrl + "/api/mailings/{id}";
        if (id === undefined || id === null)
            throw new globalThis.Error("The parameter 'id' must be defined.");
        url_ = url_.replace("{id}", encodeURIComponent("" + id));
        ...
        return this.http.fetch(url_, options_).then((_response: Response) => {
            return this.processMailingsPUT(_response);
        });
    }

    protected processMailingsPUT(response: Response): Promise<MailingDto> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
     ...
     * @return OK
     */
    mailingsDELETE(id: string): Promise<void> {
        let url_ = this.baseUrl + "/api/mailings/{id}";
        if (id === undefined || id === null)
            throw new globalThis.Error("The parameter 'id' must be defined.");
        url_ = url_.replace("{id}", encodeURIComponent("" + id));
        ...
        return this.http.fetch(url_, options_).then((_response: Response) => {
            return this.processMailingsDELETE(_response);
        });
    }

    protected processMailingsDELETE(response: Response): Promise<void> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
     ...
     * @return OK
     */
    clustersPOST(id: string, clusterId: string): Promise<MailingDto> {
        let url_ = this.baseUrl + "/api/mailings/{id}/targets/clusters/{clusterId}";
        if (id === undefined || id === null)
            throw new globalThis.Error("The parameter 'id' must be defined.");
        url_ = url_.replace("{id}", encodeURIComponent("" + id));
        if (clusterId === undefined || clusterId === null)
            throw new globalThis.Error("The parameter 'clusterId' must be defined.");
        ...
        return this.http.fetch(url_, options_).then((_response: Response) => {
            return this.processClustersPOST(_response);
        });
    }

    protected processClustersPOST(response: Response): Promise<MailingDto> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
     ...
     * @return OK
     */
    clustersDELETE(id: string, clusterId: string): Promise<void> {
        let url_ = this.baseUrl + "/api/mailings/{id}/targets/clusters/{clusterId}";
        if (id === undefined || id === null)
            throw new globalThis.Error("The parameter 'id' must be defined.");
        url_ = url_.replace("{id}", encodeURIComponent("" + id));
        ...
        return this.http.fetch(url_, options_).then((_response: Response) => {
            return this.processClustersDELETE(_response);
        });
    }

    protected processClustersDELETE(response: Response): Promise<void> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
     ...
     * @return OK
     */
    groupinstancesPOST(id: string, instanceId: string): Promise<MailingDto> {
        let url_ = this.baseUrl + "/api/mailings/{id}/targets/groupinstances/{instanceId}";
        if (id === undefined || id === null)
            throw new globalThis.Error("The parameter 'id' must be defined.");
        url_ = url_.replace("{id}", encodeURIComponent("" + id));
        if (instanceId === undefined || instanceId === null)
        ...
        return this.http.fetch(url_, options_).then((_response: Response) => {
            return this.processGroupinstancesPOST(_response);
        });
    }

    protected processGroupinstancesPOST(response: Response): Promise<MailingDto> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
     ...
     * @return OK
     */
    groupinstancesDELETE(id: string, instanceId: string): Promise<void> {
        let url_ = this.baseUrl + "/api/mailings/{id}/targets/groupinstances/{instanceId}";
        if (id === undefined || id === null)
            throw new globalThis.Error("The parameter 'id' must be defined.");
        url_ = url_.replace("{id}", encodeURIComponent("" + id));
        ...
        return this.http.fetch(url_, options_).then((_response: Response) => {
            return this.processGroupinstancesDELETE(_response);
        });
    }

    protected processGroupinstancesDELETE(response: Response): Promise<void> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
     ...
     * @return OK
     */
    mailingsPreview(id: string): Promise<MailingPreviewDto> {
        let url_ = this.baseUrl + "/api/mailings/{id}/preview";
        if (id === undefined || id === null)
            throw new globalThis.Error("The parameter 'id' must be defined.");
        url_ = url_.replace("{id}", encodeURIComponent("" + id));
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.fetch(url_, options_).then((_response: Response) => {
            return this.processMailingsPreview(_response);
        });
    }

    protected processMailingsPreview(response: Response): Promise<MailingPreviewDto> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = MailingPreviewDto.fromJS(resultData200);
            return result200;
            });
        } else if (status === 400) {
            return response.text().then((_responseText) => {
        ...
        return Promise.resolve<MailingPreviewDto>(null as any);
    }
    ...
    proof(id: string): Promise<void> {
        let url_ = this.baseUrl + "/api/mailings/{id}/proof";
        if (id === undefined || id === null)
            throw new globalThis.Error("The parameter 'id' must be defined.");
        url_ = url_.replace("{id}", encodeURIComponent("" + id));
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.fetch(url_, options_).then((_response: Response) => {
            return this.processProof(_response);
        });
    }

    protected processProof(response: Response): Promise<void> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
    ...
    send(id: string): Promise<void> {
        let url_ = this.baseUrl + "/api/mailings/{id}/send";
        if (id === undefined || id === null)
            throw new globalThis.Error("The parameter 'id' must be defined.");
        url_ = url_.replace("{id}", encodeURIComponent("" + id));
        url_ = url_.replace(/[?&]$/, "");
     ...
     * @return OK
     */
    stats(id: string): Promise<MailingStatsDto> {
        let url_ = this.baseUrl + "/api/mailings/{id}/stats";
        if (id === undefined || id === null)
            throw new globalThis.Error("The parameter 'id' must be defined.");
        url_ = url_.replace("{id}", encodeURIComponent("" + id));
        url_ = url_.replace(/[?&]$/, "");
    ...
    protected processStats(response: Response): Promise<MailingStatsDto> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = MailingStatsDto.fromJS(resultData200);
            return result200;
            });
        } else if (status === 400) {
            return response.text().then((_responseText) => {
        ...
        return Promise.resolve<MailingStatsDto>(null as any);
    }

    /**
     * @return OK
     */
    targetCount(id: string): Promise<number> {
        let url_ = this.baseUrl + "/api/mailings/{id}/target-count";
        if (id === undefined || id === null)
            throw new globalThis.Error("The parameter 'id' must be defined.");
        url_ = url_.replace("{id}", encodeURIComponent("" + id));
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.fetch(url_, options_).then((_response: Response) => {
            return this.processTargetCount(_response);
        });
    }

    protected processTargetCount(response: Response): Promise<number> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
     ...
     * @return OK
     */
    recipients(id: string, page: number | undefined, pageSize: number | undefined): Promise<PagedResultOfMailingRecipientDto> {
        let url_ = this.baseUrl + "/api/mailings/{id}/recipients?";
        if (id === undefined || id === null)
            throw new globalThis.Error("The parameter 'id' must be defined.");
        url_ = url_.replace("{id}", encodeURIComponent("" + id));
        if (page === null)
    ...
    protected processRecipients(response: Response): Promise<PagedResultOfMailingRecipientDto> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = PagedResultOfMailingRecipientDto.fromJS(resultData200);
            return result200;
            });
        } else if (status === 400) {
            return response.text().then((_responseText) => {
        ...
        return Promise.resolve<PagedResultOfMailingRecipientDto>(null as any);
    }

    /**
     * @return OK
     */
    mailLayoutsAll(): Promise<MailLayoutDto[]> {
        let url_ = this.baseUrl + "/api/MailLayouts";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.fetch(url_, options_).then((_response: Response) => {
            return this.processMailLayoutsAll(_response);
        });
    }

    protected processMailLayoutsAll(response: Response): Promise<MailLayoutDto[]> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
            ...
            if (Array.isArray(resultData200)) {
                result200 = [] as any;
                for (let item of resultData200)
                    result200!.push(MailLayoutDto.fromJS(item));
            }
            else {
                result200 = null as any;
            }
        ...
        return Promise.resolve<MailLayoutDto[]>(null as any);
    }

    /**
     * @return OK
     */
    mailLayoutsPOST(body: UpsertMailLayoutRequest): Promise<MailLayoutDto> {
        let url_ = this.baseUrl + "/api/MailLayouts";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.fetch(url_, options_).then((_response: Response) => {
            return this.processMailLayoutsPOST(_response);
        });
    }

    protected processMailLayoutsPOST(response: Response): Promise<MailLayoutDto> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = MailLayoutDto.fromJS(resultData200);
            return result200;
            });
        } else if (status === 400) {
            return response.text().then((_responseText) => {
     ...
     * @return OK
     */
    mailLayoutsGET(id: string): Promise<MailLayoutDto> {
        let url_ = this.baseUrl + "/api/MailLayouts/{id}";
        if (id === undefined || id === null)
            throw new globalThis.Error("The parameter 'id' must be defined.");
        url_ = url_.replace("{id}", encodeURIComponent("" + id));
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.fetch(url_, options_).then((_response: Response) => {
            return this.processMailLayoutsGET(_response);
        });
    }

    protected processMailLayoutsGET(response: Response): Promise<MailLayoutDto> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
     ...
     * @return OK
     */
    mailLayoutsPUT(id: string, body: UpsertMailLayoutRequest): Promise<MailLayoutDto> {
        let url_ = this.baseUrl + "/api/MailLayouts/{id}";
        if (id === undefined || id === null)
            throw new globalThis.Error("The parameter 'id' must be defined.");
        url_ = url_.replace("{id}", encodeURIComponent("" + id));
        ...
        return this.http.fetch(url_, options_).then((_response: Response) => {
            return this.processMailLayoutsPUT(_response);
        });
    }

    protected processMailLayoutsPUT(response: Response): Promise<MailLayoutDto> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
     ...
     * @return OK
     */
    mailLayoutsDELETE(id: string): Promise<void> {
        let url_ = this.baseUrl + "/api/MailLayouts/{id}";
        if (id === undefined || id === null)
            throw new globalThis.Error("The parameter 'id' must be defined.");
        url_ = url_.replace("{id}", encodeURIComponent("" + id));
        ...
        return this.http.fetch(url_, options_).then((_response: Response) => {
            return this.processMailLayoutsDELETE(_response);
        });
    }

    protected processMailLayoutsDELETE(response: Response): Promise<void> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
     ...
     * @return OK
     */
    senders(): Promise<MailSenderInfoDto[]> {
        let url_ = this.baseUrl + "/api/mail/senders";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.fetch(url_, options_).then((_response: Response) => {
            return this.processSenders(_response);
        });
    }

    protected processSenders(response: Response): Promise<MailSenderInfoDto[]> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
            ...
            if (Array.isArray(resultData200)) {
                result200 = [] as any;
                for (let item of resultData200)
                    result200!.push(MailSenderInfoDto.fromJS(item));
            }
            else {
                result200 = null as any;
            }
        ...
        return Promise.resolve<MailSenderInfoDto[]>(null as any);
    }
     ...
     * @return OK
     */
    mailTemplatesAll(kind: MailTemplateKind | undefined): Promise<MailTemplateDto[]> {
        let url_ = this.baseUrl + "/api/MailTemplates?";
        if (kind === null)
        ...
        return this.http.fetch(url_, options_).then((_response: Response) => {
            return this.processMailTemplatesAll(_response);
        });
    }

    protected processMailTemplatesAll(response: Response): Promise<MailTemplateDto[]> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
            ...
            if (Array.isArray(resultData200)) {
                result200 = [] as any;
                for (let item of resultData200)
                    result200!.push(MailTemplateDto.fromJS(item));
            }
            else {
                result200 = null as any;
            }
        ...
        return Promise.resolve<MailTemplateDto[]>(null as any);
    }

    /**
     * @return OK
     */
    mailTemplatesPOST(body: UpsertMailTemplateRequest): Promise<MailTemplateDto> {
        let url_ = this.baseUrl + "/api/MailTemplates";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.fetch(url_, options_).then((_response: Response) => {
            return this.processMailTemplatesPOST(_response);
        });
    }

    protected processMailTemplatesPOST(response: Response): Promise<MailTemplateDto> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = MailTemplateDto.fromJS(resultData200);
            return result200;
            });
        } else if (status === 400) {
            return response.text().then((_responseText) => {
     ...
     * @return OK
     */
    mailTemplatesGET(id: string): Promise<MailTemplateDto> {
        let url_ = this.baseUrl + "/api/MailTemplates/{id}";
        if (id === undefined || id === null)
            throw new globalThis.Error("The parameter 'id' must be defined.");
        url_ = url_.replace("{id}", encodeURIComponent("" + id));
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.fetch(url_, options_).then((_response: Response) => {
            return this.processMailTemplatesGET(_response);
        });
    }

    protected processMailTemplatesGET(response: Response): Promise<MailTemplateDto> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
     ...
     * @return OK
     */
    mailTemplatesPUT(id: string, body: UpsertMailTemplateRequest): Promise<MailTemplateDto> {
        let url_ = this.baseUrl + "/api/MailTemplates/{id}";
        if (id === undefined || id === null)
            throw new globalThis.Error("The parameter 'id' must be defined.");
        url_ = url_.replace("{id}", encodeURIComponent("" + id));
        ...
        return this.http.fetch(url_, options_).then((_response: Response) => {
            return this.processMailTemplatesPUT(_response);
        });
    }

    protected processMailTemplatesPUT(response: Response): Promise<MailTemplateDto> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
     ...
     * @return OK
     */
    mailTemplatesDELETE(id: string): Promise<void> {
        let url_ = this.baseUrl + "/api/MailTemplates/{id}";
        if (id === undefined || id === null)
            throw new globalThis.Error("The parameter 'id' must be defined.");
        url_ = url_.replace("{id}", encodeURIComponent("" + id));
        ...
        return this.http.fetch(url_, options_).then((_response: Response) => {
            return this.processMailTemplatesDELETE(_response);
        });
    }

    protected processMailTemplatesDELETE(response: Response): Promise<void> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
     ...
     * @return OK
     */
    placeholders(templateId: string | undefined): Promise<MailPlaceholderDto[]> {
        let url_ = this.baseUrl + "/api/MailTemplates/placeholders?";
        if (templateId === null)
        ...
        return this.http.fetch(url_, options_).then((_response: Response) => {
            return this.processPlaceholders(_response);
        });
    }

    protected processPlaceholders(response: Response): Promise<MailPlaceholderDto[]> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
            ...
            if (Array.isArray(resultData200)) {
                result200 = [] as any;
                for (let item of resultData200)
                    result200!.push(MailPlaceholderDto.fromJS(item));
            }
            else {
                result200 = null as any;
            }
        ...
        return Promise.resolve<MailPlaceholderDto[]>(null as any);
    }

    /**
     * @return OK
     */
    preview(id: string, body: MailTemplatePreviewRequest): Promise<MailTemplatePreviewDto> {
        let url_ = this.baseUrl + "/api/MailTemplates/{id}/preview";
        if (id === undefined || id === null)
            throw new globalThis.Error("The parameter 'id' must be defined.");
        url_ = url_.replace("{id}", encodeURIComponent("" + id));
        url_ = url_.replace(/[?&]$/, "");
    ...
    protected processPreview(response: Response): Promise<MailTemplatePreviewDto> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = MailTemplatePreviewDto.fromJS(resultData200);
            return result200;
            });
        } else if (status === 400) {
            return response.text().then((_responseText) => {
        ...
        return Promise.resolve<MailTemplatePreviewDto>(null as any);
    }
     ...
     * @return OK
     */
    conflict(equipmentId: string | undefined, date: string | undefined, startTime: string | undefined, endTime: string | undefined): Promise<MaterialReservationConflictDto> {
     ...
     * @return OK
     */
    materialReservationPATCH(id: string, body: UpdateMaterialReservationRequest): Promise<MaterialReservationDto> {
    ...
    protected processMemberClustersAll(response: Response): Promise<MemberClusterDto[]> {
        ...
        if (status === 200) {
            ...
            if (Array.isArray(resultData200)) {
                result200 = [] as any;
                for (let item of resultData200)
                    result200!.push(MemberClusterDto.fromJS(item));
            }
            else {
                result200 = null as any;
            }
    ...
    protected processMembersAll(response: Response): Promise<ClusterMemberDto[]> {
        ...
        if (status === 200) {
            ...
            if (Array.isArray(resultData200)) {
                result200 = [] as any;
                for (let item of resultData200)
                    result200!.push(ClusterMemberDto.fromJS(item));
            }
            else {
                result200 = null as any;
            }
    ...
    protected processMine(response: Response): Promise<OutingOverviewGroupDto[]> {
        ...
        if (status === 200) {
            ...
            if (Array.isArray(resultData200)) {
                result200 = [] as any;
                for (let item of resultData200)
                    result200!.push(OutingOverviewGroupDto.fromJS(item));
            }
            else {
                result200 = null as any;
            }
    ...
    protected processMyInstances(response: Response): Promise<OutingMyInstanceDto[]> {
        ...
        if (status === 200) {
            ...
            if (Array.isArray(resultData200)) {
                result200 = [] as any;
                for (let item of resultData200)
                    result200!.push(OutingMyInstanceDto.fromJS(item));
            }
            else {
                result200 = null as any;
            }
    ...
    protected processInstanceHistory(response: Response): Promise<OutingHistorySeasonGroupDto[]> {
        ...
        if (status === 200) {
            ...
            if (Array.isArray(resultData200)) {
                result200 = [] as any;
                for (let item of resultData200)
                    result200!.push(OutingHistorySeasonGroupDto.fromJS(item));
            }
            else {
                result200 = null as any;
            }
     ...
     * @return OK
     */
    instances(instanceId: string, view: OutingView | undefined, page: number | undefined, pageSize: number | undefined): Promise<PagedResultOfOutingListItemDto> {
        let url_ = this.baseUrl + "/api/Outings/instances/{instanceId}?";
        if (instanceId === undefined || instanceId === null)
            throw new globalThis.Error("The parameter 'instanceId' must be defined.");
        url_ = url_.replace("{instanceId}", encodeURIComponent("" + instanceId));
        if (view === null)
            throw new globalThis.Error("The parameter 'view' cannot be null.");
     ...
     * @return OK
     */
    assignRole(id: string, userId: string, body: SetParticipantRoleRequest): Promise<OutingDetailDto> {
    ...
    protected processChangelog(response: Response): Promise<OutingChangelogEntryDto[]> {
        ...
        if (status === 200) {
            ...
            if (Array.isArray(resultData200)) {
                result200 = [] as any;
                for (let item of resultData200)
                    result200!.push(OutingChangelogEntryDto.fromJS(item));
            }
            else {
                result200 = null as any;
            }
    ...
    protected processSignupCategoriesAll(response: Response): Promise<SignupCategoryDto[]> {
        ...
        if (status === 200) {
            ...
            if (Array.isArray(resultData200)) {
                result200 = [] as any;
                for (let item of resultData200)
                    result200!.push(SignupCategoryDto.fromJS(item));
            }
            else {
                result200 = null as any;
            }
     ...
     * @return OK
     */
    responsesPUT(id: string, responseId: string, body: UpdateResponseRequest): Promise<SignupResponseDto> {
        ...
        if (_data) {
            ...
            if (Array.isArray(_data["days"])) {
                ...
                for (let item of _data["days"])
                    this.days!.push(AvailabilityDayDto.fromJS(item));
            }
        }
    }
...
export enum BluePermission {
    ...
    AdminModifyMailTemplates = "AdminModifyMailTemplates",
    AdminModifyMailings = "AdminModifyMailings",
}
    ...
    init(_data?: any) {
        if (_data) {
            ...
            if (Array.isArray(_data["outings"])) {
                this.outings = [] as any;
                for (let item of _data["outings"])
                    this.outings!.push(OutingTimelineEntryDto.fromJS(item));
            }
        }
    }
...
export class MailingDto implements IMailingDto {
    ...
    proofSendCount!: number;
    sentAt!: Date | undefined;
    targetClusters!: MailingTargetClusterDto[];
    targetGroupInstances!: MailingTargetGroupInstanceDto[];
    ...
    init(_data?: any) {
        if (_data) {
            ...
            this.bodyMarkdown = _data["bodyMarkdown"];
            this.senderKey = _data["senderKey"];
            this.templateId = _data["templateId"];
            this.layoutId = _data["layoutId"];
            this.status = _data["status"];
            this.proofSendCount = _data["proofSendCount"];
            this.sentAt = _data["sentAt"] ? new Date(_data["sentAt"].toString()) : undefined as any;
            if (Array.isArray(_data["targetClusters"])) {
                this.targetClusters = [] as any;
                for (let item of _data["targetClusters"])
                    this.targetClusters!.push(MailingTargetClusterDto.fromJS(item));
            }
            if (Array.isArray(_data["targetGroupInstances"])) {
                this.targetGroupInstances = [] as any;
                for (let item of _data["targetGroupInstances"])
                    this.targetGroupInstances!.push(MailingTargetGroupInstanceDto.fromJS(item));
            }
        }
    }
    ...
    toJSON(data?: any) {
        ...
        data["bodyMarkdown"] = this.bodyMarkdown;
        data["senderKey"] = this.senderKey;
        data["templateId"] = this.templateId;
        data["layoutId"] = this.layoutId;
        data["status"] = this.status;
        data["proofSendCount"] = this.proofSendCount;
        data["sentAt"] = this.sentAt ? this.sentAt.toISOString() : undefined as any;
        if (Array.isArray(this.targetClusters)) {
            data["targetClusters"] = [];
            for (let item of this.targetClusters)
                data["targetClusters"].push(item ? item.toJSON() : undefined as any);
        }
        if (Array.isArray(this.targetGroupInstances)) {
            data["targetGroupInstances"] = [];
            for (let item of this.targetGroupInstances)
                data["targetGroupInstances"].push(item ? item.toJSON() : undefined as any);
        }
        return data;
    }
}
...
export class MailingLinkStatDto implements IMailingLinkStatDto {
    originalUrl!: string;
    clickCount!: number;

    [key: string]: any;

    constructor(data?: IMailingLinkStatDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (this as any)[property] = (data as any)[property];
    ...
    static fromJS(data: any): MailingLinkStatDto {
        data = typeof data === 'object' ? data : {};
        let result = new MailingLinkStatDto();
        result.init(data);
        return result;
    }
...
export interface IMailingLinkStatDto {
    originalUrl: string;
    clickCount: number;
...
export class MailingPreviewDto implements IMailingPreviewDto {
    subject!: string;
    htmlBody!: string;
    ...
    constructor(data?: IMailingPreviewDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (this as any)[property] = (data as any)[property];
    ...
    init(_data?: any) {
        if (_data) {
            ...
            this.plainTextBody = _data["plainTextBody"];
        }
    }

    static fromJS(data: any): MailingPreviewDto {
        data = typeof data === 'object' ? data : {};
        let result = new MailingPreviewDto();
        result.init(data);
        return result;
    }
    ...
    toJSON(data?: any) {
        ...
        data["plainTextBody"] = this.plainTextBody;
        return data;
    }
}

export interface IMailingPreviewDto {
    subject: string;
    htmlBody: string;
    plainTextBody: string | undefined;
...
export class MailingRecipientDto implements IMailingRecipientDto {
    id!: string;
    ...
    constructor(data?: IMailingRecipientDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (this as any)[property] = (data as any)[property];
    ...
    static fromJS(data: any): MailingRecipientDto {
        data = typeof data === 'object' ? data : {};
        let result = new MailingRecipientDto();
        result.init(data);
        return result;
    }
...
export interface IMailingRecipientDto {
    id: string;
    userId: string | undefined;
    email: string;
    fullName: string;
...
export class MailingStatsDto implements IMailingStatsDto {
    sentCount!: number;
    openedCount!: number;
    linkStats!: MailingLinkStatDto[];

    [key: string]: any;

    constructor(data?: IMailingStatsDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (this as any)[property] = (data as any)[property];
    ...
    init(_data?: any) {
        if (_data) {
            ...
            this.sentCount = _data["sentCount"];
            this.openedCount = _data["openedCount"];
            if (Array.isArray(_data["linkStats"])) {
                this.linkStats = [] as any;
                for (let item of _data["linkStats"])
                    this.linkStats!.push(MailingLinkStatDto.fromJS(item));
            }
        }
    }

    static fromJS(data: any): MailingStatsDto {
        data = typeof data === 'object' ? data : {};
        let result = new MailingStatsDto();
        result.init(data);
        return result;
    }
    ...
    toJSON(data?: any) {
        ...
        if (Array.isArray(this.linkStats)) {
            data["linkStats"] = [];
            for (let item of this.linkStats)
                data["linkStats"].push(item ? item.toJSON() : undefined as any);
        }
        return data;
    }
}

export interface IMailingStatsDto {
    sentCount: number;
    openedCount: number;
    linkStats: MailingLinkStatDto[];
...
export class MailingTargetClusterDto implements IMailingTargetClusterDto {
    ...
    constructor(data?: IMailingTargetClusterDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (this as any)[property] = (data as any)[property];
    ...
    init(_data?: any) {
        if (_data) {
            ...
            this.memberClusterId = _data["memberClusterId"];
            this.memberClusterName = _data["memberClusterName"];
            this.lastSentAt = _data["lastSentAt"] ? new Date(_data["lastSentAt"].toString()) : undefined as any;
        }
    }

    static fromJS(data: any): MailingTargetClusterDto {
        data = typeof data === 'object' ? data : {};
        let result = new MailingTargetClusterDto();
        result.init(data);
        return result;
    }
    ...
    toJSON(data?: any) {
        ...
        data["memberClusterId"] = this.memberClusterId;
        data["memberClusterName"] = this.memberClusterName;
        data["lastSentAt"] = this.lastSentAt ? this.lastSentAt.toISOString() : undefined as any;
        return data;
    }
}

export interface IMailingTargetClusterDto {
    memberClusterId: string;
    memberClusterName: string;
    lastSentAt: Date | undefined;
...
export class MailingTargetGroupInstanceDto implements IMailingTargetGroupInstanceDto {
    userGroupInstanceId!: string;
    ...
    constructor(data?: IMailingTargetGroupInstanceDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (this as any)[property] = (data as any)[property];
    ...
    static fromJS(data: any): MailingTargetGroupInstanceDto {
        data = typeof data === 'object' ? data : {};
        let result = new MailingTargetGroupInstanceDto();
        result.init(data);
        return result;
    }
...
export interface IMailingTargetGroupInstanceDto {
    userGroupInstanceId: string;
    userGroupName: string;
    lastSentAt: Date | undefined;
...
export class MailLayoutDto implements IMailLayoutDto {
    id!: string;
    name!: string;
    headerHtml!: string;
    footerHtml!: string;
    ...
    constructor(data?: IMailLayoutDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (this as any)[property] = (data as any)[property];
    ...
    static fromJS(data: any): MailLayoutDto {
        data = typeof data === 'object' ? data : {};
        let result = new MailLayoutDto();
        result.init(data);
        return result;
    }
...
export interface IMailLayoutDto {
    id: string;
    name: string;
    headerHtml: string;
    footerHtml: string;
...
export class MailPlaceholderDto implements IMailPlaceholderDto {
    token!: string;
    description!: string;

    [key: string]: any;

    constructor(data?: IMailPlaceholderDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (this as any)[property] = (data as any)[property];
    ...
    static fromJS(data: any): MailPlaceholderDto {
        data = typeof data === 'object' ? data : {};
        let result = new MailPlaceholderDto();
        result.init(data);
        return result;
    }
...
export interface IMailPlaceholderDto {
    token: string;
    description: string;
...
export class MailSenderInfoDto implements IMailSenderInfoDto {
    key?: string;
    displayName?: string;

    [key: string]: any;

    constructor(data?: IMailSenderInfoDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (this as any)[property] = (data as any)[property];
    ...
    static fromJS(data: any): MailSenderInfoDto {
        data = typeof data === 'object' ? data : {};
        let result = new MailSenderInfoDto();
        result.init(data);
        return result;
    }
...
export interface IMailSenderInfoDto {
    key?: string;
    displayName?: string;
...
export class MailTemplateDto implements IMailTemplateDto {
    ...
    defaultSenderKey!: string | undefined;
    ...
    init(_data?: any) {
        if (_data) {
            ...
            this.bodyMarkdown = _data["bodyMarkdown"];
            this.defaultLayoutId = _data["defaultLayoutId"];
            this.defaultSenderKey = _data["defaultSenderKey"];
        }
    }
    ...
    toJSON(data?: any) {
        ...
        data["bodyMarkdown"] = this.bodyMarkdown;
        data["defaultLayoutId"] = this.defaultLayoutId;
        data["defaultSenderKey"] = this.defaultSenderKey;
        return data;
    }
}
...
export class MailTemplatePreviewDto implements IMailTemplatePreviewDto {
    subject!: string;
    htmlBody!: string;
    ...
    constructor(data?: IMailTemplatePreviewDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (this as any)[property] = (data as any)[property];
    ...
    static fromJS(data: any): MailTemplatePreviewDto {
        data = typeof data === 'object' ? data : {};
        let result = new MailTemplatePreviewDto();
        result.init(data);
        return result;
    }
...
export interface IMailTemplatePreviewDto {
    subject: string;
    htmlBody: string;
    plainTextBody: string;
...
export class MailTemplatePreviewRequest implements IMailTemplatePreviewRequest {
    ...
    constructor(data?: IMailTemplatePreviewRequest) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (this as any)[property] = (data as any)[property];
    ...
    static fromJS(data: any): MailTemplatePreviewRequest {
        data = typeof data === 'object' ? data : {};
        let result = new MailTemplatePreviewRequest();
        result.init(data);
        return result;
    }
...
export interface IMailTemplatePreviewRequest {
    subjectTemplate: string | undefined;
    bodyMarkdown: string | undefined;
    layoutId: string | undefined;
    ...
    init(_data?: any) {
        if (_data) {
            ...
            if (Array.isArray(_data["boats"])) {
                this.boats = [] as any;
                for (let item of _data["boats"])
                    this.boats!.push(MaterialPlannerBoatDto.fromJS(item));
            }
        }
    }
    ...
    toJSON(data?: any) {
        ...
        if (Array.isArray(this.boats)) {
            ...
            for (let item of this.boats)
                data["boats"].push(item ? item.toJSON() : undefined as any);
        }
        return data;
    }
}
...
export class MaterialReservationConflictDto implements IMaterialReservationConflictDto {
    ...
    init(_data?: any) {
        if (_data) {
            ...
            this.conflictingReservation = _data["conflictingReservation"] ? MaterialReservationDto.fromJS(_data["conflictingReservation"]) : undefined as any;
        }
    }
    ...
    toJSON(data?: any) {
        ...
        data["conflictingReservation"] = this.conflictingReservation ? this.conflictingReservation.toJSON() : undefined as any;
        return data;
    }
}
...
export class OutingDetailDto implements IOutingDetailDto {
    ...
    init(_data?: any) {
        if (_data) {
            ...
            this.outingDate = _data["outingDate"] ? new Date(_data["outingDate"].toString()) : undefined as any;
            this.outingDateEnd = _data["outingDateEnd"] ? new Date(_data["outingDateEnd"].toString()) : undefined as any;
    ...
    toJSON(data?: any) {
        ...
        data["outingDateEnd"] = this.outingDateEnd ? this.outingDateEnd.toISOString() : undefined as any;
        ...
        if (_data) {
            ...
            if (Array.isArray(_data["instances"])) {
                ...
                for (let item of _data["instances"])
                    this.instances!.push(OutingMyInstanceDto.fromJS(item));
            }
        }
    }
    ...
    init(_data?: any) {
        if (_data) {
            ...
            if (Array.isArray(_data["outings"])) {
                this.outings = [] as any;
                for (let item of _data["outings"])
                    this.outings!.push(OutingListItemDto.fromJS(item));
            }
        }
    }
...
export class PagedResultOfMailingRecipientDto implements IPagedResultOfMailingRecipientDto {
    items!: MailingRecipientDto[];
    page!: number;
    pageSize!: number;
    totalCount!: number;
    ...
    constructor(data?: IPagedResultOfMailingRecipientDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (this as any)[property] = (data as any)[property];
    ...
    init(_data?: any) {
        if (_data) {
            ...
            if (Array.isArray(_data["items"])) {
                this.items = [] as any;
                for (let item of _data["items"])
                    this.items!.push(MailingRecipientDto.fromJS(item));
            }
            this.page = _data["page"];
            this.pageSize = _data["pageSize"];
            this.totalCount = _data["totalCount"];
    ...
    static fromJS(data: any): PagedResultOfMailingRecipientDto {
        data = typeof data === 'object' ? data : {};
        let result = new PagedResultOfMailingRecipientDto();
        result.init(data);
        return result;
    }
...
export interface IPagedResultOfMailingRecipientDto {
    items: MailingRecipientDto[];
    page: number;
    pageSize: number;
    totalCount: number;
    ...
    init(_data?: any) {
        if (_data) {
            ...
            if (Array.isArray(_data["items"])) {
                this.items = [] as any;
                for (let item of _data["items"])
                    this.items!.push(OutingListItemDto.fromJS(item));
            }
            this.page = _data["page"];
            this.pageSize = _data["pageSize"];
            this.totalCount = _data["totalCount"];
...
export class ReorderFieldsRequest implements IReorderFieldsRequest {
    ...
    init(_data?: any) {
        if (_data) {
            ...
            if (Array.isArray(_data["orderedFieldIds"])) {
                ...
                for (let item of _data["orderedFieldIds"])
                    this.orderedFieldIds!.push(item);
            }
        }
    }
    ...
    toJSON(data?: any) {
        ...
        if (Array.isArray(this.orderedFieldIds)) {
            ...
            for (let item of this.orderedFieldIds)
                data["orderedFieldIds"].push(item);
        }
        return data;
    }
}
    ...
    init(_data?: any) {
        if (_data) {
            ...
            if (Array.isArray(_data["blocks"])) {
                this.blocks = [] as any;
                for (let item of _data["blocks"])
                    this.blocks!.push(AvailabilityBlockInputDto.fromJS(item));
            }
        }
    }
...
export class SignupAdminDetailDto implements ISignupAdminDetailDto {
    ...
    init(_data?: any) {
        if (_data) {
            ...
            if (Array.isArray(_data["clusterIds"])) {
                ...
                for (let item of _data["clusterIds"])
                    this.clusterIds!.push(item);
            }
            if (Array.isArray(_data["fields"])) {
                this.fields = [] as any;
                for (let item of _data["fields"])
                    this.fields!.push(SignupInputFieldDto.fromJS(item));
            }
            if (Array.isArray(_data["responses"])) {
                this.responses = [] as any;
                for (let item of _data["responses"])
                    this.responses!.push(SignupResponseDto.fromJS(item));
            }
        }
    }
    ...
    toJSON(data?: any) {
        ...
        if (Array.isArray(this.clusterIds)) {
            data["clusterIds"] = [];
            for (let item of this.clusterIds)
                data["clusterIds"].push(item);
        }
...
export class SignupDetailDto implements ISignupDetailDto {
    ...
    init(_data?: any) {
        if (_data) {
            ...
            this.myResponse = _data["myResponse"] ? SignupResponseDto.fromJS(_data["myResponse"]) : undefined as any;
        }
    }
...
export class UpsertMailingRequest implements IUpsertMailingRequest {
    subject!: string;
    bodyMarkdown!: string;
    senderKey!: string;
    templateId!: string | undefined;
    ...
    constructor(data?: IUpsertMailingRequest) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (this as any)[property] = (data as any)[property];
    ...
    static fromJS(data: any): UpsertMailingRequest {
        data = typeof data === 'object' ? data : {};
        let result = new UpsertMailingRequest();
        result.init(data);
        return result;
    }
...
export interface IUpsertMailingRequest {
    subject: string;
    bodyMarkdown: string;
    senderKey: string;
    templateId: string | undefined;
...
export class UpsertMailLayoutRequest implements IUpsertMailLayoutRequest {
    name!: string;
    headerHtml!: string;
    footerHtml!: string;
    isDefault!: boolean;
    ...
    constructor(data?: IUpsertMailLayoutRequest) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (this as any)[property] = (data as any)[property];
    ...
    static fromJS(data: any): UpsertMailLayoutRequest {
        data = typeof data === 'object' ? data : {};
        let result = new UpsertMailLayoutRequest();
        result.init(data);
        return result;
    }
...
export interface IUpsertMailLayoutRequest {
    name: string;
    headerHtml: string;
    footerHtml: string;
    isDefault: boolean;
...
export class UpsertMailTemplateRequest implements IUpsertMailTemplateRequest {
    name!: string;
    kind!: MailTemplateKind;
    subjectTemplate!: string;
    bodyMarkdown!: string;
    ...
    constructor(data?: IUpsertMailTemplateRequest) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (this as any)[property] = (data as any)[property];
    ...
    static fromJS(data: any): UpsertMailTemplateRequest {
        data = typeof data === 'object' ? data : {};
        let result = new UpsertMailTemplateRequest();
        result.init(data);
        return result;
    }
...
export interface IUpsertMailTemplateRequest {
    name: string;
    kind: MailTemplateKind;
    subjectTemplate: string;
    bodyMarkdown: string;
